...
/**
 * 2-3 tree is a tree data structure in which every internal node (non-leaf node)
 * has either one data element and two children or two data elements and three children.
