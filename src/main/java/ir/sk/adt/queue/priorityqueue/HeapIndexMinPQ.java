 ...
 */
public class HeapIndexMinPQ<Key extends Comparable<Key>> implements IndexMinPQ<Key>, Iterable<Integer> {
    ...
    private class HeapIterator implements Iterator<Integer> {
        // create a new pq
        private HeapIndexMinPQ<Key> copy;

        // add all elements to copy of heap
        // takes linear time since already in heap order so no keys move
        public HeapIterator() {
            copy = new HeapIndexMinPQ<Key>(pq.length - 1);
            for (int i = 1; i <= n; i++)
